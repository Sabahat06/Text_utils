...
export default function About() {
    ...
    const [buttonText, setMyButtonText] = useState("Enable Dark Mode")
    ...
    const changeMode = () => {
        if(myStyles.color === 'white') {
            ...
            setMyButtonText('Enable Dark Mode')
        } else {
            setMyStyles({
                color: 'white',
            ...
            setMyButtonText('Enable Light Mode')
        }
    ...
    <div className='container' style={myStyles}>
        ...
        <button type="button" class="btn btn-primary" onClick={changeMode}>{buttonText}</button>
        </div>
